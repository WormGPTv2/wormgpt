...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/wormgpt.proto')
...
async function main() {
  ...
  const client = new wormgptProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mWormGPT gRPC CLI\x1b[0m')
