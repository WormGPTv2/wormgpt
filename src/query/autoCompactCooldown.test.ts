...
const SAVED_ENV = {
  ...
  WORMGPT_MAX_ACTIVE_MESSAGES: process.env.WORMGPT_MAX_ACTIVE_MESSAGES,
  WORMGPT_MAX_ACTIVE_MESSAGES_HARD_CAP:
    process.env.WORMGPT_MAX_ACTIVE_MESSAGES_HARD_CAP,
}
...
beforeEach(async () => {
  ...
  tempDir = mkdtempSync(join(tmpdir(), 'wormgpt-autocompact-test-'))
  ...
  delete process.env.WORMGPT_MAX_ACTIVE_MESSAGES
  delete process.env.WORMGPT_MAX_ACTIVE_MESSAGES_HARD_CAP
})
...
test('invalid active-message hard cap override keeps default safety cap', async () => {
  process.env.WORMGPT_MAX_ACTIVE_MESSAGES_HARD_CAP = '100O'
...
test('explicit zero active-message hard cap override disables safety cap', async () => {
  process.env.WORMGPT_MAX_ACTIVE_MESSAGES_HARD_CAP = '0'
