...
const PROTO_PATH = path.resolve(import.meta.dirname, '../proto/wormgpt.proto')
...
const wormgptProto = protoDescriptor.wormgpt.v1
...
export class GrpcServer {
  ...
  constructor() {
    ...
    this.server.addService(wormgptProto.AgentService.service, {
      ...
      try {
        if (clientMessage.request) {
          ...
          engine = new QueryEngine({
            ...
            mcpClients: [],
            // Register WormGPT's built-in agents (general-purpose,
