 ...
 * (e.g. "@gitlawb/wormgpt@latest") with the given package manager.
 */
export function getGlobalInstallArgs(
  ...
  switch (pm) {
    ...
    case 'yarn':
      ...
      // for the documented wormgpt install path.
...
/**
 * Detect which package manager owns the currently running WormGPT install.
 *
 * Strategy:
