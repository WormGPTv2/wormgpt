...
/**
 * How the *currently running* WormGPT installation should be updated.
 *
 ...
 * build the user is running. Custom-PACKAGE_URL builds (WormGPT's
 * `@gitlawb/wormgpt`) are safe to self-update.
 *
 * Shared by the `wormgpt update` CLI and the `/update` slash command so both
