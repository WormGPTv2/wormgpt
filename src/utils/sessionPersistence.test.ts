...
describe('sessionPersistence', () => {
  const testSessionDir = join(process.env.TEMP_DIR ?? '/tmp', 'wormgpt-test-sessions')

  beforeEach(async () => {
    process.env.WORMGPT_TEST_SESSIONS_DIR = testSessionDir
  ...
  afterEach(() => {
    delete process.env.WORMGPT_TEST_SESSIONS_DIR
  })
