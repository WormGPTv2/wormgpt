...
mock.module('../config.js', () => ({
  ...
  getManagedClaudeRulesDir: () => '/tmp/wormgpt-managed-rules',
  getMemoryPath: () => '/tmp/wormgpt-memory.md',
  getOrCreateUserID: () => 'test-user-id',
  getProjectPathForConfig: () => '/tmp/wormgpt-project-config.json',
  getRemoteControlAtStartup: () => false,
  getUserClaudeRulesDir: () => '/tmp/wormgpt-user-rules',
...
mock.module('./marketplaceManager.js', () => ({
  ...
  getMarketplacesCacheDir: () => '/tmp/wormgpt-marketplaces',
  ...
  test('uses known marketplaces as the installed source of truth', async () => {
    knownMarketplaces = {
      'claude-plugins-official': {
        installLocation: '/tmp/wormgpt-marketplaces/claude-plugins-official',
      },
    }
