 ...
 *
 * Usage:
 *   wormgpt --provider openai --model gpt-4o
 *   wormgpt --provider gemini --model gemini-2.0-flash
 *   wormgpt --provider mistral --model ministral-3b-latest
 *   wormgpt --provider ollama --model llama3.2
 *   wormgpt --provider anthropic   (default, no-op)
 */
 ...
 *
 * Issue #808: `wormgpt --model <name>` should work standalone so users can
