...
const pathsBySource: Record<SettingSource, string | null> = {
  userSettings: normalize('/tmp/wormgpt/user/settings.json'),
  projectSettings: normalize('/tmp/wormgpt/project/.wormgpt/settings.json'),
  localSettings: normalize('/tmp/wormgpt/project/.wormgpt/settings.local.json'),
  flagSettings: null,
  policySettings: normalize('/tmp/wormgpt/managed/managed-settings.json'),
}
...
async function importFreshModule(): Promise<SettingsChangeDetectorModule> {
  ...
  activeDetector._setDependenciesForTesting({
    ...
    getManagedSettingsDropInDir: () =>
      normalize('/tmp/wormgpt/managed/managed-settings.d'),
