...
function summarizeOllamaContextWarning(
  ...
  return {
    ...
    details: [
      ...
      'WormGPT requests 32768 tokens for Ollama chats. If `ollama ps` keeps showing a smaller CONTEXT after a new request, restart Ollama and verify with `ollama ps`.',
    ],
    summary: `Ollama CONTEXT: ${warning.contextValue} (WormGPT requests 32K)`,
  }
}
