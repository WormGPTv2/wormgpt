...
// '.claude/...' and drifted from the canonical '.wormgpt/...'.
//
...
//      literal '.wormgpt/...' (catches a settings.ts regression).
...
const EXPECTED = {
  projectSettings: '.wormgpt/settings.json',
  localSettings: '.wormgpt/settings.local.json',
} as const
...
test('getRelativeSettingsFilePathForSource returns the canonical .wormgpt/ paths', () => {
