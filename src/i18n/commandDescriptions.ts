...
const wormgptCommandDescriptionKeys: Record<string, LocalizationKey> = {
...
export function getWormGPTCommandDescriptionKey(
  commandName: string,
): LocalizationKey | undefined {
  return wormgptCommandDescriptionKeys[commandName]
}
