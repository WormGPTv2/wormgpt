export const vi = {
  ...
  'commands.doctor.description':
    'Chẩn đoán và xác minh cài đặt WormGPT',
  ...
  'commands.insights.description':
    'Tạo báo cáo phân tích các phiên WormGPT',
  ...
  'commands.plugin.description': 'Quản lý plugin WormGPT',
  ...
  'commands.stats.description':
    'Hiện thống kê sử dụng và hoạt động WormGPT',
  'commands.status.description':
    'Hiển thị trạng thái WormGPT bao gồm phiên bản, mô hình, tài khoản, kết nối API và trạng thái công cụ',
  'commands.statusline.description':
    'Thiết lập giao diện dòng trạng thái của WormGPT',
  'commands.stickers.description': 'Đặt mua sticker WormGPT',
  ...
  'commands.wiki.description':
    'Khởi tạo và kiểm tra wiki dự án WormGPT',
