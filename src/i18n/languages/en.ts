export const en = {
  ...
  'commands.doctor.description':
    'Diagnose and verify your WormGPT installation and settings',
  ...
  'commands.insights.description':
    'Generate a report analyzing your WormGPT sessions',
  ...
  'commands.plugin.description': 'Manage WormGPT plugins',
  ...
  'commands.stats.description':
    'Show your WormGPT usage statistics and activity',
  'commands.status.description':
    'Show WormGPT status including version, model, account, API connectivity, and tool statuses',
  'commands.statusline.description': "Set up WormGPT's status line UI",
  'commands.stickers.description': 'Order WormGPT stickers',
  ...
  'commands.wiki.description':
    'Initialize and inspect the WormGPT project wiki',
