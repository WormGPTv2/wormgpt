...
const ENV_VAR = 'WORMGPT_LOCAL_FAST_PATH'
...
describe('getLocalFastPathConfig — explicit env override', () => {
  test('WORMGPT_LOCAL_FAST_PATH=1 forces on against a public host', () => {
  ...
  test('WORMGPT_LOCAL_FAST_PATH=0 forces off against localhost', () => {
