...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to WormGPT now.</p>
    <p>WormGPT will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in WormGPT.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in WormGPT.</p>
  </body>
</html>`
}
