...
export const WORMGPT_DIRNAME = '.wormgpt'
export const WIKI_DIRNAME = 'wiki'

export function getWikiPaths(cwd: string): WikiPaths {
  const root = join(cwd, WORMGPT_DIRNAME, WIKI_DIRNAME)
  ...
  return {
    ...
    conventionsCacheFile: join(cwd, WORMGPT_DIRNAME, '.conventions-cache.json'),
  }
}
