...
/** Source for loading filesystem-based settings. 'user' - Global user settings (~/.wormgpt/settings.json). 'project' - Project settings (.wormgpt/settings.json). 'local' - Local settings (.wormgpt/settings.local.json). */
