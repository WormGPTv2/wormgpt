...
export const commands: SlashCommand[] = [
  ...
  { name: 'wiki', description: 'Initialize and inspect the WormGPT project wiki', category: 'context', args: '[init|status]' },
  ...
  { name: 'plugin', description: 'Manage WormGPT plugins', category: 'tools' },
  ...
  { name: 'statusline', description: "Set up WormGPT's status line UI", category: 'customization' },
  ...
  { name: 'stickers', description: 'Order WormGPT stickers', category: 'customization' },
  ...
  { name: 'doctor', description: 'Diagnose and verify your WormGPT installation and settings', category: 'diagnostics' },
  ...
  { name: 'insights', description: 'Generate a report analyzing your WormGPT sessions', category: 'diagnostics' },
  { name: 'release-notes', description: 'View release notes', category: 'diagnostics' },
  { name: 'feedback', description: 'Submit feedback about WormGPT', category: 'diagnostics', args: '[report]' },
]
