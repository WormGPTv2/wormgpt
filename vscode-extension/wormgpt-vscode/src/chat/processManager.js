/**
 * ProcessManager — spawns WormGPT in print/SDK mode and manages the
...
class ProcessManager {
  /**
   * @param {object} opts
   * @param {string} opts.command - The wormgpt binary (e.g. 'wormgpt')
   ...
   */
  constructor(opts) {
    this._command = opts.command || 'wormgpt';
